...
<?php $__env->startSection('title', 'Thời khóa biểu Giảng dạy'); ?>
...
<div class="row mb-4">
    ...
    <div class="col-md-4 text-end">
        <div class="badge bg-primary fs-6">
            ...
            <?php echo e($totalClasses); ?> lớp giảng dạy
        </div>
    </div>
</div>
...
<div class="card mb-3">
    <div class="card-body">
        <div class="row g-3 align-items-end">
            <form class="col-12 col-lg-6" method="GET" action="<?php echo e(route('lecturer.dashboard')); ?>">
                <div class="row g-2">
            ...
            <div class="col-12 col-lg-6 d-flex flex-wrap justify-content-lg-end align-items-center gap-2">
                <div class="btn-group" role="group" aria-label="View Mode">
                    <a class="btn btn-outline-secondary btn-sm <?php echo e($view==='week' ? 'active' : ''); ?>" href="<?php echo e(route('lecturer.dashboard', ['academic_year'=>$academicYear,'term'=>$term,'view'=>'week','date'=>$baseDate])); ?>">
                        <i class="fas fa-calendar-week me-1"></i>Tuần
                    </a>
                    <a class="btn btn-outline-secondary btn-sm <?php echo e($view==='month' ? 'active' : ''); ?>" href="<?php echo e(route('lecturer.dashboard', ['academic_year'=>$academicYear,'term'=>$term,'view'=>'month','date'=>$baseDate])); ?>">
                        <i class="fas fa-calendar-alt me-1"></i>Tháng
                    </a>
                    <a class="btn btn-outline-secondary btn-sm <?php echo e($view==='list' ? 'active' : ''); ?>" href="<?php echo e(route('lecturer.dashboard', ['academic_year'=>$academicYear,'term'=>$term,'view'=>'list','date'=>$baseDate])); ?>">
                        <i class="fas fa-list me-1"></i>Danh sách
                    </a>
                </div>

                <div class="btn-group" role="group" aria-label="Navigate">
                    <a class="btn btn-outline-secondary btn-sm" title="Trước" href="<?php echo e(route('lecturer.dashboard', ['academic_year'=>$academicYear,'term'=>$term,'view'=>$view,'date'=>$prevDate])); ?>">
                    ...
                    <a class="btn btn-outline-secondary btn-sm" title="Sau" href="<?php echo e(route('lecturer.dashboard', ['academic_year'=>$academicYear,'term'=>$term,'view'=>$view,'date'=>$nextDate])); ?>">
                        <i class="fas fa-chevron-right"></i>
                    </a>
                    <a class="btn btn-outline-primary btn-sm" href="<?php echo e(route('lecturer.dashboard', ['academic_year'=>$academicYear,'term'=>$term,'view'=>$view])); ?>">Hôm nay</a>
                </div>

                <div class="btn-group" role="group" aria-label="Exports">
                    <a class="btn btn-outline-success btn-sm" href="<?php echo e(route('lecturer.timetable.exportCsv', ['academic_year'=>$academicYear,'term'=>$term])); ?>">
                        <i class="fas fa-file-excel me-1"></i>Excel/CSV
                    </a>
                    <a class="btn btn-outline-danger btn-sm" target="_blank" href="<?php echo e(route('lecturer.timetable.print', ['academic_year'=>$academicYear,'term'=>$term])); ?>">
                        <i class="fas fa-file-pdf me-1"></i>PDF
                    </a>
                    <a class="btn btn-outline-dark btn-sm" href="<?php echo e(route('lecturer.timetable.ics', ['academic_year'=>$academicYear,'term'=>$term])); ?>">
                    ...
                    <?php for($slot = 0; $slot < max(1, $maxSlots); $slot++): ?>
                        ...
                        <td class="p-2" style="vertical-align: top;">
                            ...
                            <div class="class-box p-3" style="background: linear-gradient(135deg, #e3f2fd, #bbdefb); border-left: 4px solid #1976d2; border-radius: 6px; cursor: pointer;"
                                onclick="openClassDetail(<?php echo e($class['id']); ?>)">
                                ...
                                <div class="mt-2">
                                    ...
                                    <span class="badge bg-info ms-2">
                                        <i class="fas fa-users me-1"></i><?php echo e($class['enrollment']); ?>
            ...
            <table class="table table-hover mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th>Ca (Tiết)</th>
                        <th>Phòng</th>
                        <th style="width:120px">Sĩ số</th>
                        <th style="width:80px"></th>
                    </tr>
                </thead>
                <tbody>
                    <?php $__currentLoopData = ($listSections ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($s->current_enrollment ?? 0); ?>/<?php echo e($s->max_capacity); ?></td>
                        <td class="text-end">
                            <button class="btn btn-sm btn-primary" onclick="openClassDetail(<?php echo e($s->id); ?>)"><i class="fas fa-eye"></i></button>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-top" style="min-width: 180px;">
                            ...
                            <div class="border rounded p-2 mt-2" style="cursor:pointer; background:#f8fbff; border-left:3px solid #1976d2;" onclick="openClassDetail(<?php echo e($c['id']); ?>)">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('lecturer.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\quanlytkbieu\resources\views/lecturer/dashboard.blade.php ENDPATH**/ ?>