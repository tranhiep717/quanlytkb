...
<?php $__env->startSection('title','Học phần đã đăng ký'); ?>
    ...
    <div class="card-body">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <small class="text-muted">Năm học <?php echo e($year); ?> - <?php echo e($term); ?></small>
            </div>
            <div class="col-md-4 text-end">
                <div class="badge bg-success fs-6">
                    <i class="fas fa-book me-1"></i>
                    Tổng: <?php echo e($credits); ?> tín chỉ
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $regs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    $s = $r->classSection;
                    $enrolled = \App\Models\Registration::where('class_section_id', $s->id)->count();
                    ?>
                    <tr>
                        <td><span class="badge bg-primary"><?php echo e($s->section_code); ?></span></td>
                        <td>
                            <strong><?php echo e($s->course->code); ?></strong> - <?php echo e($s->course->name); ?>

                            <br><small class="text-muted"><?php echo e($s->course->credits); ?> tín chỉ</small>
                        </td>
                        <td>
                            <span class="badge bg-info"><?php echo e(['','Thứ 2','Thứ 3','Thứ 4','Thứ 5','Thứ 6','Thứ 7','Chủ nhật'][$s->day_of_week] ?? ''); ?></span>
                            <br><small class="text-muted">Tiết <?php echo e($s->shift->start_period); ?>-<?php echo e($s->shift->end_period); ?></small>
                        </td>
                        <td><span class="badge bg-secondary"><?php echo e($s->room->code); ?></span></td>
                        <td><small><?php echo e($s->lecturer->name ?? 'N/A'); ?></small></td>
                        <td>
                            <span class="badge <?php echo e($enrolled >= $s->max_capacity ? 'bg-danger' : 'bg-success'); ?>">
                                <?php echo e($enrolled); ?>/<?php echo e($s->max_capacity); ?>

                            </span>
                        </td>
                        <td class="text-center">
                            <button class="btn btn-sm btn-primary" onclick="openSwapModal(<?php echo e($r->id); ?>, '<?php echo e($s->course->code); ?>', '<?php echo e($s->course->name); ?>', <?php echo e($s->course_id); ?>, <?php echo e($s->id); ?>)">
                                <i class="fas fa-exchange-alt me-1"></i>Đổi lớp
                            </button>
                            <button class="btn btn-sm btn-danger" onclick="openCancelModal(<?php echo e($r->id); ?>, '<?php echo e($s->course->code); ?>', '<?php echo e($s->course->name); ?>', '<?php echo e($s->section_code); ?>')">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('student.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\quanlytkbieu\resources\views/student/registrations/my.blade.php ENDPATH**/ ?>