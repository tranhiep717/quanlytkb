...
<body>
    <div class="wrap">
        ...
        <div class="content">
            <p>Xin chào<?php echo e(isset($user->name) ? ' ' . $user->name : ''); ?>,</p>
            ...
            <p>Thời gian: <?php echo e(now()->format('d/m/Y H:i')); ?></p>
            <p>Địa chỉ email: <strong><?php echo e($user->email); ?></strong></p>
...
</html><?php /**PATH C:\xampp\htdocs\quanlytkbieu\resources\views/emails/password-changed.blade.php ENDPATH**/ ?>