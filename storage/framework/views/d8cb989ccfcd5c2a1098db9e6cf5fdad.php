...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
    ...
    <a href="<?php echo e(route('faculties.create')); ?>" style="background:#10b981;color:#fff;padding:10px 16px;border-radius:8px;text-decoration:none;">+ Tạo khoa mới</a>
</div>

<!-- Bộ lọc và tìm kiếm -->
<div class="card" style="margin-bottom:16px;">
    <form method="GET" action="<?php echo e(route('faculties.index')); ?>">
        <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(220px, 1fr)); gap:12px;">
            <div>
                <label style="font-size:13px;color:#94a3b8;display:block;margin-bottom:4px;">Tìm kiếm</label>
                <input type="text" name="search" value="<?php echo e($filters['search'] ?? ''); ?>" placeholder="Mã khoa, tên khoa..." style="width:100%;">
            </div>
            <div>
                ...
                <select name="status" style="width:100%;">
                    ...
                    <option value="inactive" <?php echo e(($filters['status'] ?? '') === 'inactive' ? 'selected' : ''); ?>>Ngưng hoạt động</option>
                </select>
            </div>
            <div>
                ...
                <select name="dean_id" style="width:100%;">
                    ...
                    <option value="<?php echo e($dean->id); ?>" <?php echo e(($filters['dean_id'] ?? '') == $dean->id ? 'selected' : ''); ?>>
                        <?php echo e($dean->name); ?>
...
<div class="card">
    <table style="width:100%; border-collapse:collapse;">
        ...
        <tbody>
            ...
            <tr style="border-bottom:1px solid rgba(148,163,184,.1);">
                ...
                <td style="padding:12px;"><?php echo e($faculty->name); ?></td>
                <td style="padding:12px;"><?php echo e($faculty->dean->name ?? '-'); ?></td>
                <td style="padding:12px;">
                ...
                <td style="padding:12px;text-align:center;"><?php echo e($faculty->users_count ?? 0); ?></td>
                <td style="padding:12px;text-align:center;"><?php echo e($faculty->courses_count ?? 0); ?></td>
                <td style="padding:12px;text-align:right;">
                    <div style="display:flex;gap:8px;justify-content:flex-end;">
                        <!-- Xem chi tiết -->
                        <a href="<?php echo e(route('faculties.show', $faculty)); ?>" title="Xem chi tiết" style="color:#334155;display:inline-flex;align-items:center;justify-content:center;width:32px;height:32px;border-radius:6px;border:1px solid #e2e8f0;">
                        ...
                        <!-- Sửa -->
                        <a href="<?php echo e(route('faculties.edit', $faculty)); ?>" title="Sửa" style="color:#1d4ed8;display:inline-flex;align-items:center;justify-content:center;width:32px;height:32px;border-radius:6px;border:1px solid #bfdbfe;background:#eff6ff;">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18">
                        ...
                        <!-- Xóa -->
                        <form action="<?php echo e(route('faculties.destroy', $faculty)); ?>" method="POST" style="display:inline;" class="js-delete-form">
                            <?php echo csrf_field(); ?>
    ...
    <div style="margin-top:16px; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:12px;">
        <div style="color:#64748b; font-size:14px;">
            <?php if($faculties->total() > 0): ?>
            Hiển thị <?php echo e($faculties->firstItem()); ?>–<?php echo e($faculties->lastItem()); ?> của <?php echo e($faculties->total()); ?>
        ...
        <div>
            <?php echo e($faculties->withQueryString()->links()); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\quanlytkbieu\resources\views/admin/faculties/index.blade.php ENDPATH**/ ?>