...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> - Hệ Thống Quản Lý Tín Chỉ</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            <h2>🎓 Admin Panel</h2>
            <div class="user-info"><?php echo e(auth()->user()->name ?? 'Administrator'); ?></div>
        </div>
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu-section">
                ...
                <a href="<?php echo e(route('faculties.index')); ?>" class="menu-item <?php echo e(request()->routeIs('faculties.*') ? 'active' : ''); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('lecturers.index')); ?>" class="menu-item <?php echo e(request()->routeIs('lecturers.*') ? 'active' : ''); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('courses.index')); ?>" class="menu-item <?php echo e(request()->routeIs('courses.*') ? 'active' : ''); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('class-sections.index')); ?>" class="menu-item <?php echo e(request()->routeIs('class-sections.*') ? 'active' : ''); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('class-sections.assignments')); ?>" class="menu-item <?php echo e(request()->routeIs('class-sections.assignments') ? 'active' : ''); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('rooms.index')); ?>" class="menu-item <?php echo e(request()->routeIs('rooms.*') ? 'active' : ''); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('shifts.index')); ?>" class="menu-item <?php echo e(request()->routeIs('shifts.*') ? 'active' : ''); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <div class="menu-section">
                ...
                <a href="<?php echo e(route('registration-waves.index')); ?>" class="menu-item <?php echo e(request()->routeIs('registration-waves.*') ? 'active' : ''); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <div class="menu-section">
                ...
                <a href="<?php echo e(route('announcements.index')); ?>" class="menu-item <?php echo e(request()->routeIs('announcements.*') ? 'active' : ''); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.logs')); ?>" class="menu-item <?php echo e(request()->routeIs('admin.logs') ? 'active' : ''); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.backup')); ?>" class="menu-item <?php echo e(request()->routeIs('admin.backup') ? 'active' : ''); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <div class="main-content">
        ...
        <div class="top-bar">
            ...
            <div class="top-bar-actions">
                <form action="<?php echo e(route('admin.context.update')); ?>" method="POST" class="toolbar">
                    <?php echo csrf_field(); ?>
                    <?php
                    ...
                    <label style="font-size:12px;color:#718096;">
                        ...
                        <select name="term" onchange="this.form.submit()">
                            <?php $__currentLoopData = $terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e($currentTerm === $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </label>
                </form>
...
</html><?php /**PATH C:\xampp\htdocs\quanlytkbieu\resources\views/admin/layout.blade.php ENDPATH**/ ?>