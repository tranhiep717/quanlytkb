            ...
            <div class="filter-row">
                ...
                <div class="filter-group">
                    ...
                    <select name="building" class="filter-input">
                        ...
                        <option value="<?php echo e($building); ?>"
                            <?php echo e(($filters['building'] ?? '') == $building ? 'selected' : ''); ?>><?php echo e($building); ?></option>
                ...
                <div class="filter-group">
                    ...
                    <input type="number" name="min_capacity" class="filter-input" placeholder="VD: 30"
                        value="<?php echo e($filters['min_capacity'] ?? ''); ?>" min="0">
                </div>
                <div class="filter-group">
                    <label class="filter-label">🖥️ Thiết bị</label>
                    <select name="equipment" class="filter-input">
                        <option value="">Tất cả</option>
                        <?php $__currentLoopData = $equipmentOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($eq); ?>" <?php echo e(($filters['equipment'] ?? '') == $eq ? 'selected' : ''); ?>><?php echo e($eq); ?>
                ...
                <div class="filter-group">
                    ...
                    <select name="status" class="filter-input">
                        ...
                        <option value="inactive" <?php echo e(($filters['status'] ?? '') == 'inactive' ? 'selected' : ''); ?>>Tạm
                            ngưng</option>
                    </select>
                </div>
                <div style="display:flex; gap:8px;">
                    ...
                    <?php if(request()->hasAny(['search','building','min_capacity','equipment','status'])): ?>
    ...
    <div class="rooms-table-container">
        <table class="rooms-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><code
                            style="background:#fef3c7; color:#92400e; padding:4px 8px; border-radius:4px; font-size:13px; font-weight:700;"><?php echo e($room->code); ?></code>
                    </td>
                    <td style="font-weight:600;"><?php echo e($room->name ?? 'Chưa đặt tên'); ?></td>
                    ...
                    <td><span
                            ...
                            <?php echo e($room->capacity ?? 0); ?> người</span></td>
                    <td>
                        <?php if($room->equipment && count($room->equipment) > 0): ?>
                        <?php $__currentLoopData = array_slice($room->equipment, 0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="equipment-tag"><?php echo e($eq); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if(count($room->equipment) > 2): ?>
                        <span style="color:#64748b; font-size:11px;">+<?php echo e(count($room->equipment) - 2); ?> khác</span>
                        <?php endif; ?>
                        <?php else: ?>
                    ...
                    <td><span
                            class="status-badge status-<?php echo e($room->status); ?>"><?php echo e($room->status === 'active' ? '✓ Hoạt động' : '⏸ Tạm ngưng'); ?></span>
                    </td>
                    <td style="text-align:center;">
                        <div style="display:inline-flex; gap:6px;">
                            <button onclick="viewRoomDetail(<?php echo e($room->id); ?>)" class="action-btn btn-view"
                                title="Xem chi tiết">
                                <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <a href="<?php echo e(route('rooms.edit', $room)); ?>" class="action-btn btn-edit" title="Sửa">
                                <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                    <path
        ...
        <div style="padding:20px; border-top:1px solid #e2e8f0;"><?php echo e($rooms->appends($filters)->links()); ?></div>
        <?php endif; ?>
    </div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\quanlytkbieu\resources\views/admin/rooms/index.blade.php ENDPATH**/ ?>