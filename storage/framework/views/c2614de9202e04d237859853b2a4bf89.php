...
<div class="row justify-content-center">
    <div class="col-md-6">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('lecturer.password.change.submit')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('lecturer.profile')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('lecturer.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\quanlytkbieu\resources\views/lecturer/profile/change-password.blade.php ENDPATH**/ ?>