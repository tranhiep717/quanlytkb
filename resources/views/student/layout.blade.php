...
<head>
    ...
    <title>@yield('title', 'Sinh viên') - Hệ Thống Quản Lý Tín Chỉ</title>
...
<body>
    ...
    <div class="container-wrapper">
        <div class="sidebar" id="sidebar">
            ...
            <a href="{{ route('student.offerings') }}" class="menu-item {{ request()->routeIs('student.offerings') ? 'active' : '' }}">
                <i class="fas fa-edit"></i>
                Đăng ký học phần
            </a>

            <a href="{{ route('student.my') }}" class="menu-item {{ request()->routeIs('student.my') ? 'active' : '' }}">
            ...
            <a href="{{ route('student.profile.show') }}" class="menu-item {{ request()->routeIs('student.profile.show') ? 'active' : '' }}">
