...
<div style="max-width:800px; margin:0 auto;">
    <div style="margin-bottom:24px;">
        <h2 style="margin:0; font-size:24px; font-weight:600; color:#1e293b;">🏫 Tạo phòng học mới</h2>
        <p style="margin:4px 0 0 0; color:#64748b; font-size:14px;">Điền đầy đủ thông tin phòng học theo yêu cầu</p>
    </div>
    ...
    <div class="card">
        <form method="POST" action="{{ route('rooms.store') }}">
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:16px;">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                        style="width:100%;background:white;color:#1e293b;border:1px solid #cbd5e0;border-radius:6px;padding:10px 12px;font-size:14px;"
                        placeholder="VD: Phòng thí nghiệm A1">
            ...
            <div style="display:flex;gap:12px;padding-top:16px;border-top:1px solid #e2e8f0;">
                <button type="submit" style="background:#10b981;color:#fff;padding:12px 24px;border-radius:8px;cursor:pointer;border:none;font-weight:500;font-size:14px;">
                    <span style="margin-right:6px;">✓</span> Tạo phòng học
                </button>
