...
<div class="card" style="max-width:700px;">
    <form method="POST" action="{{ route('faculties.store') }}">
        ...
        <div style="margin-bottom:16px;">
            ...
            <input type="text" name="code" value="{{ old('code') }}" required style="width:100%;" placeholder="VD: CNTT">
        ...
        <div style="margin-bottom:16px;">
            ...
            <input type="text" name="name" value="{{ old('name') }}" required style="width:100%;" placeholder="VD: Công Nghệ Thông Tin">
        ...
        <div style="margin-bottom:16px;">
            ...
            <input type="date" name="founding_date" value="{{ old('founding_date') }}" style="width:100%;">
        ...
        <div style="margin-bottom:16px;">
            ...
            <textarea name="description" rows="4" style="width:100%;resize:vertical;" placeholder="Mô tả về khoa...">{{ old('description') }}</textarea>
        ...
        <div style="display:flex;gap:12px;margin-top:24px;">
            <button type="submit" style="background:#10b981;color:#fff;padding:10px 20px;border-radius:8px;cursor:pointer;border:none;">Tạo khoa</button>
